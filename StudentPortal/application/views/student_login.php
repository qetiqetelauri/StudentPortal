...
<html lang="en">
  ...
  <body>
    ...
    <?php } ?>
    <?php echo form_open('student_authentification/student_login_process'); ?>
    <?php
    ...
    <div class="d-flex align-items-center justify-content-center bg-br-primary ht-100v">
      <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white rounded shadow-base">
        ...
        <form class="" action="index.html" method="post">
          ...
          <div class="mg-t-60 tx-center">Not yet a member? <a href="student_register" class="tx-info">Sign Up</a></div>
        </form>
      </div><!-- login-wrapper -->
    </div><!-- d-flex -->
    <?php echo form_close(); ?>
