  ...
  <body>
    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <ul class="br-sideleft-menu">
        ...
        <li class="br-menu-item">
          <a href="<?php echo base_url();?>index.php/admin/add_admin" class="br-menu-link">
        ...
        <div class="row row-sm">
          <div class="col-sm-6 col-xl-3">
            <div class="bg-info rounded overflow-hidden">
              <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                <i class="ion ion-university tx-60 lh-0 tx-white op-7"></i>
                <div class="mg-l-20">
                  <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">universities</p>
          ...
          <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
            <div class="bg-teal rounded overflow-hidden">
              <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                <i class="ion ion-person  tx-60 lh-0 tx-white op-7"></i>
                <div class="mg-l-20">
                  <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Lecturers</p>
                  <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">
                    <?php
                        $this->db->select('*');
          ...
          <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
            <div class="bg-primary rounded overflow-hidden">
              <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                <i class="ion ion-chatbox tx-60 lh-0 tx-white op-7"></i>
                <div class="mg-l-20">
                  <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Comments</p>
                  <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">
                    <?php
                        $this->db->select('*');
